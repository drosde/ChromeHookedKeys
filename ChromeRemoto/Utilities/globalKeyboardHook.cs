...
namespace Utilities
{
    ...
    {
        static globalKeyboardHook _instance;
        ...
        public globalKeyboardHook getInstance()
        {
            return Instance;
        }
        ...
        public void setKeys(Keys key)
        {
            Instance.HookedKeys.Add(key);
        }
        ...
        /*public void setEventsKU(gkh_KeyDown)
        {
            Instance.KeyDown += new KeyEventHandler(gkh_KeyDown);
        }*/
        #endregion
